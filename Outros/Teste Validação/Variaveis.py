...
class Var(object):
    def __init__(self):
        ...
        #=============================================================================#
                    ...
                    ### Configuração da atual disposição dos sensores na bancada ###
        self.D_Rack = [[self.H7DC_040, self.H7DC_059, self.H7DC_047, self.H7DC_046,  
                        self.H7DC_039, self.H7DC_052, self.H7DC_033, self.H7DC_057], 
                       [self.H7DC_036, self.H7DC_044, self.H7DC_042, self.H7DC_056,  
                        self.H7DC_045, self.H7DC_038, self.H7DC_032, self.H7DC_055], 
                       [self.H7DC_048, self.H7DC_049, self.H7DC_050, self.H7DC_051,  
                        self.H7DC_034, self.H7DC_053, self.H7DC_035, self.H7DC_054], 
                       [self.H7DC_037, self.H7DC_041, self.H7DC_058, self.H7DC_043,  
                        self.H7DC_060, self.H7DC_061, self.H7DC_062, self.H7DC_063]]
