...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1350, 690)#N:    V:1300, 682
        ...
        """ ABA CIENCIA ABERTA 2018 """
        
        self.CiencAberta = QtGui.QWidget()
        self.CiencAberta.setObjectName(_fromUtf8("CiencAberta"))
        #self.CiencAberta.setStyleSheet("background-color:black;");#SETA COR DE FUNDO DA ABA
        self.tabWidget.addTab(self.CiencAberta, _fromUtf8(""))
        self.tabWidget.setGeometry(5,10, 1350, 680)#680
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.CiencAberta), _translate("MainWindow", "Ciencia Aberta", None))
        
        self.groupPlot = QtGui.QGroupBox(self.CiencAberta)
        self.groupPlot.setGeometry(QtCore.QRect(20, 60, 870, 570))#686
        self.groupPlot.setObjectName(_fromUtf8("groupPlot"))
        
        self.widget_cienc = SimplePlot_cienc(self.CiencAberta)
        self.widget_cienc.setGeometry(QtCore.QRect(25, 360, 840, 250)) #10,330
        self.widget_cienc.setObjectName(_fromUtf8("widget_cienc"))
        

        # Create textbox para aba 'Ciencia aberta'
        self.logOutput_cienc = QTextEdit(self.CiencAberta)
        self.logOutput_cienc.setReadOnly(True)
        self.logOutput_cienc.setLineWrapMode(QTextEdit.NoWrap)
        self.logOutput_cienc.moveCursor(QTextCursor.End)
        self.logOutput_cienc.setGeometry(80,80,615,225)
        self.logOutput_cienc.setTextBackgroundColor(QColor.fromRgb(0,0,0))
        self.logOutput_cienc.setTextColor (QColor.fromRgb(255,0,0))

        #self.logOutput_cienc = QLineEdit(self.CiencAberta)
        #self.logOutput_cienc.setGeometry(50,50,870,250)
        #self.logOutput_cienc.setReadOnly(True)
        #self.logOutput_cienc.setText("OI")
        
        self.font1 = self.logOutput_cienc.font()
        self.font1.setFamily("Courier")
        self.font1.setPointSize(150)
        
        self.logOutput_cienc.setCurrentFont(self.font1)
        #logOutput.setTextColor(color)
        #self.logOutput_cienc.insertPlainText("0,19 mm")
        #self.logOutput_cienc.clear()

        self.groupOpcoes = QtGui.QGroupBox(self.CiencAberta)
        self.groupOpcoes.setGeometry(QtCore.QRect(920, 470, 370, 90))#686
        self.groupOpcoes.setObjectName(_fromUtf8("groupOpcoes"))
        
        self.btnTexto = QtGui.QPushButton( self.groupOpcoes)
        self.btnTexto.setGeometry(QtCore.QRect(10, 60, 75, 23))
        self.btnTexto.setObjectName(_fromUtf8("btnTexto"))
        self.btnTexto.setText(_translate("MainWindow", "Set Ref", None))

        self.refBoxCienc = QtGui.QComboBox(self.groupOpcoes)
        self.refBoxCienc.setGeometry(QtCore.QRect(10, 30, 120, 22))
        self.refBoxCienc.setObjectName(_fromUtf8("refBoxCienc"))

        self.txtLogTitle = QtGui.QLabel("DIFERENÇA DE ALTURA ENTRE SENSORES", self.CiencAberta)
        self.txtLogTitle.setGeometry(210, 25, 600, 40)#180,20
        self.font2 = QtGui.QFont("Courier", 15, QtGui.QFont.Bold)
        self.txtLogTitle.setFont(self.font2)
        
        self.txtLogMM = QtGui.QLabel("mm", self.CiencAberta)
        self.txtLogMM.setGeometry(705, 190, 180, 100)
        self.font3 = QtGui.QFont("Calibri", 75, QtGui.QFont.Bold)
        self.txtLogMM.setFont(self.font3)

        self.txtLogNeg = QtGui.QLabel("", self.CiencAberta)
        self.txtLogNeg.setGeometry(30, 150, 100, 50)
        self.txtLogNeg.setFont(self.font3)

        self.groupImagem = QtGui.QGroupBox(self.CiencAberta)
        self.groupImagem.setGeometry(QtCore.QRect(920, 60, 400, 360))#686
        self.groupImagem.setObjectName(_fromUtf8("groupImagem"))

        self.txtImagTile = QtGui.QLabel("ESCALA COMPARATIVA", self.CiencAberta)
        self.txtImagTile.setGeometry(1010, 20, 300, 50)
        #self.txtImagTile = QtGui.QLabel("ESCALA COMPARATIVA", self.groupImagem)
        #self.txtImagTile.setGeometry(50, 1, 300, 50)
        self.font4 = QtGui.QFont("Courier", 15, QtGui.QFont.Bold)
        self.txtImagTile.setFont(self.font4)

        self.txtImag = QtGui.QLabel("", self.groupImagem)
        self.txtImag.setGeometry(40, 280, 350, 100)
        self.font5 = QtGui.QFont("Courier", 13, QtGui.QFont.Bold)
        self.txtImag.setFont(self.font5)

        self.imagem1 = QLabel(self.groupImagem)
        self.imagem1.setGeometry(QtCore.QRect(10, 10, 300, 300))
        #self.imagem1 = QLabel(self.groupImagem)
        self.pixmap1 = QPixmap('bacteria.png')
        self.pixmap2 = QPixmap('magneto_v5.png')
        self.pixmap3 = QPixmap('fiocabelo.png')

        self.numPontos_cienc = QtGui.QSpinBox(self.groupOpcoes)
        self.numPontos_cienc.setGeometry(QtCore.QRect(160, 30, 56, 22))
        self.numPontos_cienc.setMinimum(2)
        self.numPontos_cienc.setMaximum(10000)
        self.numPontos_cienc.setProperty("value", 20)
        self.numPontos_cienc.setObjectName(_fromUtf8("numPontos"))

        self.txtRef = QtGui.QLabel("Referência", self.groupOpcoes)
        self.txtRef.setGeometry(QtCore.QRect(30, 5, 100, 20))
        self.txtPontos = QtGui.QLabel("Num. Pontos", self.groupOpcoes)
        self.txtPontos.setGeometry(QtCore.QRect(145, 5, 100, 20))
        self.txtOnOff = QtGui.QLabel("Imagem ON/OFF", self.groupOpcoes)
        self.txtOnOff.setGeometry(QtCore.QRect(255, 5, 120, 20))
        self.font6 = QtGui.QFont("Courier", 10)
        self.txtRef.setFont(self.font6)
        self.txtPontos.setFont(self.font6)
        self.txtOnOff.setFont(self.font6)
        
        self.imageOnOff = QtGui.QCheckBox(self.groupOpcoes)
        self.imageOnOff.setGeometry(QtCore.QRect(300, 30, 30, 17))
        #self.checkPlot13_on.setObjectName(_fromUtf8("checkPlot13"))
        
    def printImagem1(self):
...
from PlotGUI_Qwt_Multi_v3 import SimplePlot, SimplePlot_on, SimplePlot_cienc
