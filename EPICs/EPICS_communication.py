""" Implementation of local communication with a EPICs server """
...
# Defining Process Variables (PVs)
prefix = 'HLS:'
...
""" Function that reads instantaneous data collected from the sensors that are in .txt files,
    and stores it in a tupple that will be returned """
...
if __name__ == '__main__':
    ...
    driver = myDriver()  # calls the thread class that will handle data acquisition and communication
